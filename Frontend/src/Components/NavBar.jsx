...
const Navbar = () => {
    ...
    return(
        ...
        <div className = 'fixed top-0 left-0 w-full flex justify-between items-center gap-16 py-3 px-10 bg-black bg-opacity-60 backdrop-blur-md text-white shadow-lg z-50'>
            ...
            <ul className="flex gap-8 text-sm">
                {listItems.map((item) => (
                    ...
                    <Link to={item.path}>
                        ...
                        <span className="absolute left-0 bottom-[-5px] w-0 h-1 rounded-sm bg-gradient-to-r from-blue-500 to-green-500 transition-all duration-300 group-hover:w-full"></span>
                    </li>
                ))}
            </ul>
