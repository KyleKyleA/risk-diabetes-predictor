// Author: Kyle Angeles
// File-Name: Aup.jsx
// Description: Part of the terms and conidtions the user must follow in the application its self
...
function Aup() {
    ...
    return (
        ...
        <h2 className="text-white-400 text-center">Aup Policy</h2>
        <p className="text-white-400 text-center mt-4">
        Terms & Conditions
            These terms and conditions apply to the DiabetesRiskPredictor app for web browsers, together with any related services operated by Kyle Angeles (collectively, the "Application"). Kyle Angeles is hereby referred to as the "Service Provider".
            ...
            Point of Contact: The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at kyleangeles2006@gmail.com. Where the Service Provider is established outside the European Union, a legal representative in the EU has been designated in accordance with Article 13 of the DSA.
            ...
            Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at kyleangeles2006@gmail.com.


            These terms and conditions are effective as of 2026-08-02


            Contact Us
            If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at kyleangeles2006@gmail.com.
